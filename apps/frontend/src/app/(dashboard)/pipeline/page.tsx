...
const mockStages: PipelineStage[] = [
  ...
  { id: "offered", title: "Offer Sent", order: 4 },
  { id: "hired", title: "Hired", order: 5 },
];

const mockCandidates: Candidate[] = [
  { id: "1", name: "Sarah Connor", email: "sarah@example.com", role: "Senior Frontend Engineer", experience: "4 yrs", recruiter: "John Smith", status: "interview", aiScore: 92, submitted: "Oct 24", lastActivity: "2 hrs ago" },
  ...
  { id: "7", name: "Alice Wonderland", email: "alice@example.com", role: "Frontend Developer", experience: "3 yrs", recruiter: "John Smith", status: "interview", aiScore: 88, submitted: "Oct 26", lastActivity: "4 hrs ago" },
  { id: "8", name: "Bob Builder", email: "bob@example.com", role: "DevOps Engineer", experience: "8 yrs", recruiter: "Jane Doe", status: "interview", aiScore: 91, submitted: "Oct 12", lastActivity: "2 days ago" },
];
